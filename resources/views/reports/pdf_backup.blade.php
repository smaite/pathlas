...
<head>
    ...
    <style>
        ...
        * { 
        ...
        /* Header - Fixed position for repeating on every page */
        .header { 
            position: fixed;
            top: 0;
            left: 0;
        ...
        /* Patient Section - Bordered Table Style */
       .patient-section { background: {{ $lab->header_color ?? '#0066cc' }}15; border: 1px solid {{ $lab->header_color ?? '#0066cc' }}40; margin: 10px 25px; padding: 12px; }
        ...
        .results-table th { 
            background: {{ $lab->header_color ?? '#6c7a89' }}; 
            color: white; 
            padding: 10px 12px; 
            text-align: left; 
            font-size: 10px; 
        ...
        /* Footer - Fixed position for repeating on every page */
        .footer {
            width: 100%;
            position: fixed;
            bottom: 0;
...
<body>
    ...
    <div class="report-container">
        <!-- Patient Section with Proper Table Layout -->
        ...
        <div class="test-section">
            <div class="test-category">{{ $bookingTest->test->category->name ?? 'PANEL TESTS' }}</div>
        ...
        <!-- End of Report Marker (in content flow) -->
        <div style="text-align: center; padding: 20px 0; margin-top: 30px; border-top: 1px dashed #ccc;">
            <div style="font-size: 10px; color: #666;">****End of Report****</div>
