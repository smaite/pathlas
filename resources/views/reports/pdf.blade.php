                    ...
                    <td class="patient-col">
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td class="patient-value">{{ $booking->patient->name }}</td>
                            </tr>
                            <tr>
                                <td class="patient-label">Age/Gender</td>
                                <td class="patient-value">:</td>
                                <td class="patient-value">{{ $booking->patient->age }}/{{ ucfirst(substr($booking->patient->gender ?? '', 0, 1)) }}</td>
                            </tr>
                            <tr>
                                <td class="patient-label">Referred By</td>
                                <td class="patient-value">:</td>
                                <td class="patient-value">{{ $booking->referring_doctor_name ?? 'Self' }}</td>
                            </tr>
                            @if($booking->patient->phone)
                            <tr>
                                <td class="patient-label">Phone No.</td>
                                <td class="patient-value">:</td>
                                <td class="patient-value">{{ $booking->patient->phone }}</td>
                            </tr>
                            @endif
                        </table>
                    </td>
                    <td class="patient-col">
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td class="patient-value">:</td>
                                <td class="patient-value">{{ $booking->patient->patient_id }}</td>
                            </tr>
                            <tr>
                                <td class="patient-label">Reg No.</td>
                                <td class="patient-value">:</td>
                                <td class="patient-value">{{ $booking->booking_id }}</td>
                            </tr>
                            <tr>
                                <td class="patient-label">Collection Date</td>
                                <td class="patient-value">:</td>
                                <td class="patient-value">{{ $booking->collection_date ? $booking->collection_date->format('d/m/Y') : now()->format('d/m/Y') }}</td>
                            </tr>
                            <tr>
                                <td class="patient-label">Report Date</td>
                                <td class="patient-value">:</td>
                                <td class="patient-value">{{ now()->format('d/m/Y') }}</td>
                            </tr>
                        </table>
                    </td>
                </tr>
