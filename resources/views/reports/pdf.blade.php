...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .clinical-notes-title { font-weight: bold; color: #333; margin-bottom: 8px; font-size: 11px; border-bottom: 1px solid #ccc; padding-bottom: 5px; }
        .clinical-notes-content { font-size: 10px; color: #444; line-height: 1.5; }
        ...
        <div class="footer-top">
            ...
            <div class="signatures">
                <div class="signature-box">
                    @if($sig1Base64)
                    <div style="margin-bottom: 5px;"><img src="{{ $sig1Base64 }}" style="height: 35px;" alt="Signature"></div>
                    @else
