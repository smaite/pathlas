        ...
        <div class="header">
            <div class="brand-section">
                <div class="logo-col">
                    ...
                    @else
                    <div style="width:50px;height:50px;background:#111827;color:#fff;line-height:50px;text-align:center;font-weight:bold;border-radius:6px;">{{ substr($lab->name ?? 'L',0,1) }}</div>
                    @endif
                </div>
                <div class="info-col">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="item-cat">{{ $test->test->category->name }}</div>
