...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-green-50 border border-green-200 rounded-2xl p-6">
            <div class="flex justify-between items-center">
                ...
                <div class="flex gap-2">
                    ...
                    @php
                        $phone = preg_replace('/[^0-9]/', '', $booking->patient->phone);
                        if(strlen($phone) == 10) $phone = '977' . $phone;
                    ...
                    <a href="{{ $waUrl }}" target="_blank" 
                       class="px-3 py-2 bg-green-500 text-white rounded-xl hover:bg-green-600 flex items-center gap-2 text-sm">
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="space-y-2">
                <a href="{{ route('bookings.receipt', $booking) }}" target="_blank" class="block w-full px-4 py-2 bg-primary-600 text-white rounded-xl text-center hover:bg-primary-700">Print Receipt</a>
                ...
                @php
                    ...
                    $waReceiptUrl = "https://wa.me/{$phone}?text=" . urlencode($receiptMsg);
                @endphp
